...
def _comment(device, my_username, comments_list, on_comment):
    comment_button = device.find(resourceIdMatches=f'{device.app_id}:id/(row_feed_button_comment|comment_button)')
    ...
    for _ in range(2):
        ...
        comment_box = device.find(resourceIdMatches=f'{device.app_id}:id/(layout_comment_thread_edittext|layout_comment_thread_edittext_multiline|comment_composer_edit_text)')
    ...
    post_button = device.find(resourceIdMatches=f'{device.app_id}:id/(layout_comment_thread_post_button_click_area|layout_comment_thread_post_button_icon|comment_composer_post_button)')
